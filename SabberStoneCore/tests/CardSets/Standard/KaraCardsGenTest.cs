...
namespace SabberStoneCoreTest.CardSets.Standard
{
    ...
    public class NeutralKaraTest
    {
        ...
        public void AvianWatcher_KAR_037()
        {
            ...
            Assert.AreEqual(4, ((Minion) testCard2).AttackDamage);
        ...
        public void TheCurator_KAR_061()
        {
            ...
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
            Assert.AreEqual(Race.BEAST, game.CurrentPlayer.Hand[4].Card.Race);
            Assert.AreEqual(Race.DRAGON, game.CurrentPlayer.Hand[5].Card.Race);
            Assert.AreEqual(Race.MURLOC, game.CurrentPlayer.Hand[6].Card.Race);
        }
        ...
        public void NetherspiteHistorian_KAR_062()
        {
            ...
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
            Assert.AreEqual(Race.DRAGON, game.IdEntityDic[game.CurrentPlayer.Choice.Choices[0]].Card.Race);
            Assert.AreEqual(Race.DRAGON, game.IdEntityDic[game.CurrentPlayer.Choice.Choices[1]].Card.Race);
            Assert.AreEqual(Race.DRAGON, game.IdEntityDic[game.CurrentPlayer.Choice.Choices[2]].Card.Race);
        ...
        public void PrinceMalchezaar_KAR_096()
        {
            ...
            Assert.AreEqual(31, game.CurrentPlayer.Deck.Count);
        }
        ...
        public void ArcaneGiant_KAR_711()
        {
            ...
            Assert.AreEqual(12, testCard.Cost);
            ...
            Assert.AreEqual(11, testCard.Cost);
        }
        ...
        public void VioletIllusionist_KAR_712()
        {
            ...
            Assert.AreEqual(false, game.CurrentPlayer.Hero.IsImmune);
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
            Assert.AreEqual(true, game.CurrentPlayer.Hero.IsImmune);
            game.Process(EndTurnTask.Any(game.CurrentPlayer));
            Assert.AreEqual(false, game.CurrentPlayer.Hero.IsImmune);
            game.Process(EndTurnTask.Any(game.CurrentPlayer));
            Assert.AreEqual(true, game.CurrentPlayer.Hero.IsImmune);
