...
{
	public class BasicTest : IClassFixture<BasicFixture>
	{
		private readonly BasicFixture fixture;


		public BasicTest(BasicFixture fixture)
		{
			this.fixture = fixture;
		}

		[Fact]
		public void RNG_Uniformity_Test()
		{
		...
		[Fact]
		public void GameTest_Throws_GameConfigException()
		{
			GameConfig config = fixture.EmptyConfiguration;

			GameConfigException exception = Assert.Throws<GameConfigException>(() => new Game(config));
		}

		[Fact]
		public void GameTest()
		{
			var game = new Game(fixture.BasicConfiguration);
			game.StartGame();
		...
		public void SummonFailTest()
		{
			...
			config.Player1CardClass = ECardClass.PALADIN;
			config.Player2CardClass = ECardClass.MAGE;
		...
		{
			var config = GameConfig.Stamp(fixture.Conf1StartFill);
			config.Player1CardClass = ECardClass.ROGUE;
			config.Player2CardClass = ECardClass.WARLOCK;
		...
		{
			var game = new Game(fixture.Conf1StartFill);
			game.StartGame();
		...
		{
			var config = GameConfig.Stamp(fixture.Conf1StartFill);
			config.Player1CardClass = ECardClass.PRIEST;
		...
		{
			var config = GameConfig.Stamp(fixture.Conf1StartFill);
			config.Player1CardClass = ECardClass.HUNTER;
			config.Player2CardClass = ECardClass.ROGUE;
