...
namespace SabberStoneCore.Loader
{
    ...
    {
        internal const string CARD_DEFS_RESOURCE_FILE = "SabberStoneCore.resources.Data.CardDefs.xml";
        internal const string PLAY_ERRORS_RESOURCE_FILE = "SabberStoneCore.resources.Data.PlayErrors.xml‎";
        ...
        {
            var playErr =
                XDocument.Load(Assembly.GetManifestResourceStream(PLAY_ERRORS_RESOURCE_FILE));
        ...
        public List<Card> Load()
        {
            ...
            var cardDefsXml =
                XDocument.Load(Assembly.GetManifestResourceStream(CARD_DEFS_RESOURCE_FILE));
