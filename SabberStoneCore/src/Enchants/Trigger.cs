...
namespace SabberStoneCore.Enchants
{
	...
	{
		NONE, TURN_END, TURN_START, DEATH, INSPIRE, DAMAGE, HEAL, ATTACK, AFTER_ATTACK, SUMMON, PLAY_CARD, PLAY_MINION, CAST_SPELL, AFTER_CAST, SECRET_REVEALED, ICEBLOCK, PREDAMAGE,
	}
