...
namespace SabberStoneCore.Model
{
	...
	public sealed class Game : Entity
	{
		...
		/// <summary>Gets the task stack.</summary>
		...
		/// <summary>Gets or sets the collection of log entries.</summary>
		...
		/// <summary>Checks for entities which are pending to be destroyed and updated 
