...
namespace SabberStoneCore.Model.Entities
{
	...
	public partial class Entity : IEntity
	{
		...
		/// <autogeneratedoc />
		protected internal Entity(Game game, Card card, IDictionary<GameTag, int> tags, int id = -1)
		{
			if (tags == null)
		...
		public static IPlayable FromCard(Controller controller, Card card, IDictionary<GameTag, int> tags = null, IZone zone = null, int id = -1, int zonePos = -1)
		{
			...
			switch (card.Type)
			{
				case CardType.MINION:
					result = new Minion(controller, card, tags, id);
					break;

				case CardType.SPELL:
					result = new Spell(controller, card, tags, id);
					break;

				case CardType.WEAPON:
					result = new Weapon(controller, card, tags, id);
					break;
				...
				case CardType.HERO:
					...
					result = new Hero(controller, card, tags, id);
					break;
				...
				case CardType.HERO_POWER:
					...
					result = new HeroPower(controller, card, tags, id);
