...
namespace SabberStoneCore.Model.Entities
{
	...
	public partial class Minion : Character<Minion>
	{
		...
		/// <autogeneratedoc />
		public Minion(Controller controller, Card card, Dictionary<GameTag, int> tags, bool addEnchantments = true)
		...
		{
			var copy = new Minion(controller, Card, new Dictionary<GameTag, int>(_data.Tags), false);
			...
			if (copy.Enchants.Count != Enchants.Count)
				;
