...
{
	/// <summary>
	/// Base implementation of the ITargeting interface, defining that
	/// entities can exhibit targeting behaviour
	/// </summary>
	/// <seealso cref="Entity" />
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
		...
		/// <summary>Default definition of whether the entity currently requires 
		/// a target list to be calculated before use
		/// </summary>
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
		...
		/// </summary>
		/// <returns></returns>
		protected virtual IEnumerable<ICharacter> GetValidPlayTargets()
		{
			// If this is an untargeted card, return an empty list
			return !NeedsTargetList ? new List<ICharacter>() : Game.Characters.Where(TargetingRequirementsMatch);
		}


		/// <summary>Gets a value indicating if the provided target matches the targeting requirements.</summary>
		/// <param name="target"><see cref="ICharacter"/></param>
		/// <returns></returns>
		protected virtual bool TargetingRequirementsMatch(ICharacter target)
		{
			...
			foreach (KeyValuePair<EPlayReq, int> item in Card.PlayRequirements)
			{
				...
				switch (req)
				{
					...
					case EPlayReq.REQ_MINION_SLOT_OR_MANA_CRYSTAL_SLOT:
						...
						Debugging.ReportNotImplemented(this, EBlockType.PLAY, req, ELogLevel.WARNING);
						break;

					default:
						// Game.Log(ELogLevel.ERROR, EBlockType.PLAY, "Targeting", $"PlayReq {req} not in switch needs to be added!");
						Debugging.ReportNotImplemented(this, EBlockType.PLAY, req, ELogLevel.ERROR);
						break;
				}
			}
