...
namespace SabberStoneCore.Model.Entities
{
	...
	public abstract class Targeting : Entity, ITargeting
	{
		...
		/// <autogeneratedoc />
		protected Targeting(in Controller controller, in Card card, in IDictionary<GameTag, int> tags, in int id) : base(controller.Game, in card, in tags, in id)
		{
		...
		protected Targeting(in Controller controller, in Targeting targeting) : base(controller.Game, targeting)
		{
			Controller = controller;
		}
