...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
		...
		/// </summary>
		public Deck Deck => (Zones[EZone.DECK] as Deck);
		...
		/// </summary>
		public Hand Hand => (Zones[EZone.HAND] as Hand);
		...
		/// Can be empty.
		/// </summary>
		public Zone<Minion> Board => (Zones[EZone.PLAY] as Zone<Minion>);

		/// <summary>
		/// The zone containing all entities which were once in play, but now destroyed. Can be empty.
		/// </summary>
		public Zone<IPlayable> Graveyard => (Zones[EZone.GRAVEYARD] as Zone<IPlayable>);

		/// <summary>
		/// The zone containing all played secrets by this player. Can be empty.
		/// </summary>
		public Zone<Spell> Secrets => (Zones[EZone.SECRET] as Zone<Spell>);
		...
		/// </summary>
		public Zone<IPlayable> Setaside => (Zones[EZone.SETASIDE] as Zone<IPlayable>);
