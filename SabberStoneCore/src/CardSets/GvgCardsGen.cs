...
namespace SabberStoneCore.CardSets
{
	public class GvgCardsGen
	{
		private static void Druid(IDictionary<string, CardDef> cards)
		{
			...
			// - 542 = 1
			// --------------------------------------------------------
			cards.Add("GVG_035", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_080", new CardDef(new Power
			{
			...
			// - REQ_ENEMY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_031", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_ENEMY_TARGET,0}}, new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_033", new CardDef(new Power
			{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("GVG_041", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_MINION_TARGET,0}}));
		...
		private static void DruidNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: +1 Attack.
			// --------------------------------------------------------
			cards.Add("GVG_030ae", new CardDef(new Power
			{
			...
			// Text: +1 Health.
			// --------------------------------------------------------
			cards.Add("GVG_030be", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_041c", new CardDef(new Power
			{
			...
			// Text: +1 Attack.
			// --------------------------------------------------------
			cards.Add("GVG_030a", new CardDef(new Power
			{
			...
			// Text: +1 Health.
			// --------------------------------------------------------
			cards.Add("GVG_030b", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_032a", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("GVG_032b", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new DrawTask(),
					new DrawOpTask())
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_041a", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_041b", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_NUM_MINION_SLOTS,1}}, new Power
			{
		...
		private static void Hunter(IDictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_046", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_048", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_049", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_087", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_017", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_026", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_073", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_043", new CardDef(new Power
			{
		...
		private static void HunterNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: +1 Attack.
			// --------------------------------------------------------
			cards.Add("GVG_043e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_046e", new CardDef(new Power
			{
			...
			// Text: +2 Attack.
			// --------------------------------------------------------
			cards.Add("GVG_048e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_049e", new CardDef(new Power
			{
		...
		private static void Mage(IDictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_004", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - TOPDECK = 1
			// --------------------------------------------------------
			cards.Add("GVG_007", new CardDef(new Power
			{
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("GVG_122", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_001", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINIMUM_ENEMY_MINIONS,1}}, new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_003", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("GVG_005", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new IncludeTask(EntityType.MINIONS),
		...
		private static void Paladin(IDictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_060", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new IncludeTask(EntityType.MINIONS),
			...
			// - DIVINE_SHIELD = 1
			// --------------------------------------------------------
			cards.Add("GVG_062", new CardDef(new Power
			{
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_063", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_101", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("GVG_057", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("GVG_061", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - DIVINE_SHIELD = 1
			// --------------------------------------------------------
			cards.Add("GVG_059", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new RandomTask(1, EntityType.MINIONS),
		...
		private static void PaladinNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: +2/+2.
			// --------------------------------------------------------
			cards.Add("GVG_060e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_101e", new CardDef(new Power
			{
		...
		private static void Priest(IDictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_009", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_011", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_014", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_072", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_083", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_WITH_RACE,17}}, new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_008", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - SPELLPOWER = 1
			// --------------------------------------------------------
			cards.Add("GVG_010", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("GVG_012", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void PriestNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("GVG_014a", new CardDef(new Power
			{
			...
			// Text: +4 Health.
			// --------------------------------------------------------
			cards.Add("GVG_069a", new CardDef(new Power
			{
		...
		private static void Rogue(IDictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_023", new CardDef(new Power
			{
			...
			// - STEALTH = 1
			// --------------------------------------------------------
			cards.Add("GVG_025", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_027", new CardDef(new Power
			{
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_028", new CardDef(new Power
			{
			...
			// - FORGETFUL = 1
			// --------------------------------------------------------
			cards.Add("GVG_088", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_022", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_047", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_ENEMY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("GVG_024", new CardDef(new Power
			{
		...
		private static void RogueNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: Increased stats.
			// --------------------------------------------------------
			cards.Add("GVG_027e", new CardDef(new Power
			{
		...
		private static void Shaman(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("GVG_039", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.TURN_END)
				{
			...
			// - OVERLOAD_OWED = 1
			// --------------------------------------------------------
			cards.Add("GVG_040", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.DEATH)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// - OVERLOAD_OWED = 3
			// --------------------------------------------------------
			cards.Add("GVG_042", new CardDef(new Power
			{
			...
			// - FORGETFUL = 1
			// --------------------------------------------------------
			cards.Add("GVG_066", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_029", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("GVG_038", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_036", new CardDef(new Power
			{
		...
		private static void ShamanNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: +2/+2.
			// --------------------------------------------------------
			cards.Add("GVG_036e", new CardDef(new Power
			{
		...
		private static void Warlock(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("GVG_020", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.TURN_END)
				{
					SingleTask = ComplexTask.Create(
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("GVG_021", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_077", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_100", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("GVG_015", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_019", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_045", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void WarlockNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: +5/+5.
			// --------------------------------------------------------
			cards.Add("GVG_019e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_021e", new CardDef(new Power
			{
			...
			// Text: Increased stats.
			// --------------------------------------------------------
			cards.Add("GVG_100e", new CardDef(new Power
			{
		...
		private static void Warrior(IDictionary<string, CardDef> cards)
		{
			...
			// - ENRAGED = 1
			// --------------------------------------------------------
			cards.Add("GVG_051", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_053", new CardDef(new Power
			{
			...
			// - REQ_TARGET_WITH_RACE = 17
			// --------------------------------------------------------
			cards.Add("GVG_055", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_TARGET_WITH_RACE,17}}, new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_056", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_086", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_050", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINIMUM_TOTAL_MINIONS,1}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_052", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - DURABILITY = 2
			// --------------------------------------------------------
			cards.Add("GVG_054", new CardDef(new Power
			{
		...
		private static void WarriorNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: +1 Attack
			// --------------------------------------------------------
			cards.Add("GVG_051e", new CardDef(new Power
			{
			...
			// - REQ_FRIENDLY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_055e", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_FRIENDLY_TARGET,0}}, new Power
			{
			...
			// Text: Increased Attack.
			// --------------------------------------------------------
			cards.Add("GVG_086e", new CardDef(new Power
			{
			...
			// - TOPDECK = 1
			// --------------------------------------------------------
			cards.Add("GVG_056t", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void Neutral(IDictionary<string, CardDef> cards)
		{
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("GVG_006", new CardDef(new Power
			{
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("GVG_013", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_016", new CardDef(new Power
			{
			...
			// - FORGETFUL = 1
			// --------------------------------------------------------
			cards.Add("GVG_065", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_067", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.CAST_SPELL)
				{
					TriggerSource = TriggerSource.ENEMY,
			...
			// --------------------------------------------------------
			cards.Add("GVG_068", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.CAST_SPELL)
				{
					TriggerSource = TriggerSource.ENEMY,
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_069", new CardDef(new Power
			{
			...
			// - SECRET = 1
			// --------------------------------------------------------
			cards.Add("GVG_074", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_075", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_076", new CardDef(new Power
			{
			...
			// - SECRET = 1
			// --------------------------------------------------------
			cards.Add("GVG_089", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_090", new CardDef(new Power
			{
				PowerTask =
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_092", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_094", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("GVG_095", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_096", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_097", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_103", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_104", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_105", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("GVG_106", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.DEATH)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// - DIVINE_SHIELD = 1
			// --------------------------------------------------------
			cards.Add("GVG_107", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("GVG_108", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_110", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_111", new CardDef(new Power
			{
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_112", new CardDef(new Power
			{
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_113", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_114", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_116", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.DEATH)
				{
					TriggerSource = TriggerSource.ENEMY,
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_117", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.CAST_SPELL)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("GVG_118", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.CAST_SPELL)
				{
					TriggerSource = TriggerSource.ENEMY,
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GVG_119", new CardDef(new Power
			{
			...
			// - REQ_TARGET_IF_AVAILABLE = 0
			// --------------------------------------------------------
			cards.Add("GVG_120", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_WITH_RACE,20},{PlayReq.REQ_TARGET_IF_AVAILABLE,0}}, new Power
			{
				PowerTask = new DestroyTask(EntityType.TARGET)
			}));
			...
			// --------------------------------------------------------
			cards.Add("GVG_121", new CardDef(new Power
			{
		...
		private static void NeutralNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("GVG_010b", new CardDef(new Power
			{
				Enchant = new Enchant(
					Effects.Attack_N(2),
					Effects.Health_N(4),
			...
			// --------------------------------------------------------
			cards.Add("GVG_011a", new CardDef(new Power
			{
			...
			// Text: +3 Attack.
			// --------------------------------------------------------
			cards.Add("GVG_022a", new CardDef(new Power
			{
			...
			// Text: +3 Attack.
			// --------------------------------------------------------
			cards.Add("GVG_022b", new CardDef(new Power
			{
			...
			// Text: +1 Attack.
			// --------------------------------------------------------
			cards.Add("GVG_023a", new CardDef(new Power
			{
			...
			// - TAG_ONE_TURN_EFFECT = 1
			// --------------------------------------------------------
			cards.Add("GVG_057a", new CardDef(new Power
			{
			...
			// Text: Increased Attack
			// --------------------------------------------------------
			cards.Add("GVG_063a", new CardDef(new Power
			{
				Enchant = new OngoingEnchant(Effects.Attack_N(1))
			}));
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("GVG_067a", new CardDef(new Power
			{
				Enchant = new OngoingEnchant(Effects.Attack_N(1))
			}));
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("GVG_068a", new CardDef(new Power
			{
			...
			// Text: Increased Attack.
			// --------------------------------------------------------
			cards.Add("GVG_076a", new CardDef(new Power
			{
				Enchant = new OngoingEnchant(Effects.Attack_N(1))
			}));
			...
			// Text: +1/+1.
			// --------------------------------------------------------
			cards.Add("GVG_102e", new CardDef(new Power
			{
			...
			// Text: +2/+2.
			// --------------------------------------------------------
			cards.Add("GVG_104a", new CardDef(new Power
			{
			...
			// Text: Increased stats.
			// --------------------------------------------------------
			cards.Add("GVG_106e", new CardDef(new Power
			{
			...
			// - SPARE_PART = 1
			// --------------------------------------------------------
			cards.Add("PART_001e", new CardDef(new Power
			{
			...
			// - SPARE_PART = 1
			// --------------------------------------------------------
			cards.Add("PART_006a", new CardDef(new Power
			{
			...
			// - SPARE_PART = 1
			// --------------------------------------------------------
			cards.Add("PART_007e", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("GVG_110t", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new RandomTask(1, EntityType.ENEMIES),
			...
			// - CHARGE = 1
			// --------------------------------------------------------
			cards.Add("GVG_111t", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GVG_028t", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("PART_001", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_FRIENDLY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("PART_002", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_FRIENDLY_TARGET,0}}, new Power
			{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("PART_003", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - STEALTH = 1
			// --------------------------------------------------------
			cards.Add("PART_004", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_FRIENDLY_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("PART_005", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("PART_006", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("PART_007", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
