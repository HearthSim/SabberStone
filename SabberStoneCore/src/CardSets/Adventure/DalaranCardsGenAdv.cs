...
namespace SabberStoneCore.CardSets.Adventure
{
	public class DalaranCardsGenAdv
	{
		...
		private static void HeroPowers(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_03p", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_OR_ENEMY_HERO,0}}, new Power
			{
			...
			// - REQ_MINION_OR_ENEMY_HERO = 0
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_03px", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_OR_ENEMY_HERO,0}}, new Power
			{
			...
			// - REQ_HAND_NOT_FULL = 0
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_38p", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_HAND_NOT_FULL,0}}, new Power
			{
			...
			// - REQ_HAND_NOT_FULL = 0
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_38px", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_HAND_NOT_FULL,0}}, new Power
			{
			...
			// - REQ_MINION_OR_ENEMY_HERO = 0
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_41p", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_OR_ENEMY_HERO,0}}, new Power
			{
			...
			// - REQ_MINION_OR_ENEMY_HERO = 0
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_41px", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_OR_ENEMY_HERO,0}}, new Power
			{
			...
			// - REQ_HAND_NOT_FULL = 0
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_67p", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_HAND_NOT_FULL,0}}, new Power
			{
		...
		private static void NeutralNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("DALA_833", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_ENEMY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINIMUM_TOTAL_MINIONS = 1
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_03t2", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINIMUM_TOTAL_MINIONS,1}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("DALA_BOSS_38t", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
