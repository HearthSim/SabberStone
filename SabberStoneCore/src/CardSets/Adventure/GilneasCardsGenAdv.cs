...
namespace SabberStoneCore.CardSets.Adventure
{
	public class GilneasCardsGenAdv
	{
		private static void Heroes(IDictionary<string, CardDef> cards)
		{
			...
			// - 793 = 1646
			// --------------------------------------------------------
			cards.Add("GILA_400h", new CardDef(new Power
			{
			...
			// - 793 = 1596
			// --------------------------------------------------------
			cards.Add("GILA_500h3", new CardDef(new Power
			{
			...
			// - 960 = 1
			// --------------------------------------------------------
			cards.Add("GILA_500h4", new CardDef(new Power
			{
			...
			// - 793 = 1583
			// --------------------------------------------------------
			cards.Add("GILA_600h", new CardDef(new Power
			{
			...
			// - 960 = 1
			// --------------------------------------------------------
			cards.Add("GILA_600h2", new CardDef(new Power
			{
			...
			// - 793 = 1649
			// --------------------------------------------------------
			cards.Add("GILA_900h", new CardDef(new Power
			{
			...
			// - 960 = 1
			// --------------------------------------------------------
			cards.Add("GILA_900h2", new CardDef(new Power
			{
			...
			// - 843 = 48368
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_23h", new CardDef(new Power
			{
			...
			// - 843 = 48264
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_26h", new CardDef(new Power
			{
			...
			// - 843 = 48268
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_27h", new CardDef(new Power
			{
			...
			// - 843 = 48296
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_29h", new CardDef(new Power
			{
			...
			// - 843 = 48318
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_33h", new CardDef(new Power
			{
			...
			// - 843 = 48329
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_35h", new CardDef(new Power
			{
			...
			// - 843 = 48330
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_37h", new CardDef(new Power
			{
			...
			// - 793 = 1657
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_43h", new CardDef(new Power
			{
			...
			// - 793 = 1696
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_57h", new CardDef(new Power
			{
			...
			// - 793 = 1769
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_68h", new CardDef(new Power
			{
		...
		private static void MageNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_01", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_02", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_03", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_04", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_05", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_06", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_07", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_08", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_09", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_10", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Toki_11", new CardDef(new Power
			{
		...
		private static void WarriorNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_01", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_02", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_03", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_04", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_05", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_06", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_07", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_08", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_09", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_10", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_Darius_11", new CardDef(new Power
			{
		...
		private static void NeutralNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("GILA_802", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_489", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_490", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_491", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_492", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_493", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_494", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_495", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_496", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_497", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_498", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_499", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_589", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_590", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_591", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_592", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_593", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_594", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_595", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_596", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_597", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_598", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_599", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("GILA_BOSS_26t2", new CardDef(new Power
			{
