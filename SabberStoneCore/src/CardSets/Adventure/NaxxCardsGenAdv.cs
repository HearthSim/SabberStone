...
namespace SabberStoneCore.CardSets.Adventure
{
	public class NaxxCardsGenAdv
	{
		private static void Heroes(IDictionary<string, CardDef> cards)
		{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX10_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX10_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX11_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX11_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX12_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX12_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX13_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX13_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX14_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX14_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX2_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX2_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX3_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX3_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX4_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX4_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX5_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX5_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX6_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX6_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX7_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX7_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_01H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX9_01", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX9_01H", new CardDef(new Power
			{
		...
		private static void HeroPowers(IDictionary<string, CardDef> cards)
		{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_04", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_04H", new CardDef(new Power
			{
		...
		private static void NeutralNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_01e", new CardDef(new Power
			{
				// TODO [NAX15_01e] Interloper! && Test: Interloper!_NAX15_01e
				//Enchant = Enchants.Enchants.GetAutoEnchantFromText("NAX15_01e")
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_01He", new CardDef(new Power
			{
				// TODO [NAX15_01He] Interloper! && Test: Interloper!_NAX15_01He
				//Enchant = Enchants.Enchants.GetAutoEnchantFromText("NAX15_01He")
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_04a", new CardDef(new Power
			{
				// TODO [NAX15_04a] Slave of Kel'Thuzad && Test: Slave of Kel'Thuzad_NAX15_04a
				//Enchant = Enchants.Enchants.GetAutoEnchantFromText("NAX15_04a")
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX2_05e", new CardDef(new Power
			{
				// TODO [NAX2_05e] Worship && Test: Worship_NAX2_05e
				//Enchant = Enchants.Enchants.GetAutoEnchantFromText("NAX2_05e")
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX2_05He", new CardDef(new Power
			{
				// TODO [NAX2_05He] Heroic Worship && Test: Heroic Worship_NAX2_05He
				//Enchant = Enchants.Enchants.GetAutoEnchantFromText("NAX2_05He")
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX6_03te", new CardDef(new Power
			{
				// TODO [NAX6_03te] Fungal Growth && Test: Fungal Growth_NAX6_03te
				//Enchant = Enchants.Enchants.GetAutoEnchantFromText("NAX6_03te")
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX9_07e", new CardDef(new Power
			{
				// TODO [NAX9_07e] Mark of the Horsemen && Test: Mark of the Horsemen_NAX9_07e
				//Enchant = Enchants.Enchants.GetAutoEnchantFromText("NAX9_07e")
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX11_03", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX13_04H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX13_05H", new CardDef(new Power
			{
			...
			// - FREEZE = 1
			// --------------------------------------------------------
			cards.Add("NAX14_03", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_03n", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_03t", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX15_05", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX1_03", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX1h_03", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX2_05", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX2_05H", new CardDef(new Power
			{
				// TODO [NAX2_05H] Worshipper && Test: Worshipper_NAX2_05H
				InfoCardId = "NAX2_05He",
				//PowerTask = null,
				//Trigger = null,
			}));
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX4_03", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX4_03H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX6_03t", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX7_02", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_03", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_03t", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_04", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_04t", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_05", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX8_05t", new CardDef(new Power
			{
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("NAX9_02", new CardDef(new Power
			{
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("NAX9_02H", new CardDef(new Power
			{
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("NAX9_03", new CardDef(new Power
			{
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("NAX9_03H", new CardDef(new Power
			{
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("NAX9_04", new CardDef(new Power
			{
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("NAX9_04H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAXM_001", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAXM_002", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX4_05", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX5_03", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX6_04", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX7_05", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX9_07", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX10_02", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX10_02H", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("NAX12_03", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("NAX12_03H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX7_04", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX7_04H", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX9_05", new CardDef(new Power
			{
			...
			// - HIDE_WATERMARK = 1
			// --------------------------------------------------------
			cards.Add("NAX9_05H", new CardDef(new Power
			{
