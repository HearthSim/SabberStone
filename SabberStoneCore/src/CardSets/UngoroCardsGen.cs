...
namespace SabberStoneCore.CardSets
{
	public class UngoroCardsGen
	{
		private static void HeroPowers(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_917t1", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_TARGET_WITH_RACE,20}}, new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_934t2", new CardDef(new Power
			{
		...
		private static void Druid(Dictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_078", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_086", new CardDef(new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_100", new CardDef(new Power
			{
			...
			// - STEALTH = 1
			// --------------------------------------------------------
			cards.Add("UNG_101", new CardDef(new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_103", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_108", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_FRIENDLY_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("UNG_111", new CardDef(new Power
			{
			...
			// - 676 = 1
			// --------------------------------------------------------
			cards.Add("UNG_116", new CardDef(new Power
			{
		...
		private static void DruidNonCollect(Dictionary<string, CardDef> cards)
		{
			...
			// Text: +1/+1.
			// --------------------------------------------------------
			cards.Add("UNG_108e", new CardDef(new Power
			{
			...
			// Text: Costs (0).
			// --------------------------------------------------------
			cards.Add("UNG_116te", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_111t1", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_116t", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("UNG_101a", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_101b", new CardDef(new Power
			{
		...
		private static void Hunter(IDictionary<string, CardDef> cards)
		{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_800", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_WITH_DEATHRATTLE,0}}, new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_912", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_913", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_914", new CardDef(new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_915", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_WITH_RACE,20},{PlayReq.REQ_FRIENDLY_TARGET,0}}, new Power
			{
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("UNG_919", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_910", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("UNG_916", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_917", new CardDef(new Power
			{
			...
			// - 676 = 1
			// --------------------------------------------------------
			cards.Add("UNG_920", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_PLAY_MINION)
				{
					TriggerSource = TriggerSource.FRIENDLY,
		...
		private static void HunterNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_916e", new CardDef(new Power
			{
			...
			// Text: +2/+2.
			// --------------------------------------------------------
			cards.Add("UNG_917e", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_920t1", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_920t2", new CardDef(new Power
			{
		...
		private static void Mage(IDictionary<string, CardDef> cards)
		{
			...
			// - SECRET = 1
			// --------------------------------------------------------
			cards.Add("UNG_020", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_021", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_027", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_846", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("UNG_018", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
					new DamageTask(2, EntityType.TARGET, true),
			...
			// - SECRET = 1
			// --------------------------------------------------------
			cards.Add("UNG_024", new CardDef(new Power
			{
			...
			// - 676 = 1
			// --------------------------------------------------------
			cards.Add("UNG_028", new CardDef(new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_941", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_948", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_955", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void MageNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_028e", new CardDef(new Power
			{
			...
			// Text: Cost reduced.
			// --------------------------------------------------------
			cards.Add("UNG_941e", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_027t2", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
					new MoveToSetaside(EntityType.SOURCE),
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("UNG_028t", new CardDef(new Power
			{
		...
		private static void Paladin(IDictionary<string, CardDef> cards)
		{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_011", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_015", new CardDef(new Power
			{
				InfoCardId = "UNG_015e",
			...
			// - 542 = 1
			// --------------------------------------------------------
			cards.Add("UNG_953", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_CAST)
				{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_962", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_004", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("UNG_952", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - 676 = 1
			// --------------------------------------------------------
			cards.Add("UNG_954", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_CAST)
				{
			...
			// --------------------------------------------------------
			cards.Add("UNG_960", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_NUM_MINION_SLOTS,1}}, new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_961", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
				PowerTask = new AdaptTask(EntityType.TARGET)
			}));
			...
			// - DURABILITY = 3
			// --------------------------------------------------------
			cards.Add("UNG_950", new CardDef(new Power
			{
		...
		private static void PaladinNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_004e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_015e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_952e", new CardDef(new Power
			{
			...
			// Text: Storing spell.
			// --------------------------------------------------------
			cards.Add("UNG_953e", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_954t1", new CardDef(new Power
			{
		...
		private static void Priest(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_022", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_032", new CardDef(new Power
			{
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("UNG_034", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_035", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_037", new CardDef(new Power
			{
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("UNG_963", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.CAST_SPELL)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_029", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_030", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_854", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_TARGET_WITH_DEATHRATTLE,0},{PlayReq.REQ_NUM_MINION_SLOTS,1}}, new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_940", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_SUMMON)
				{
		...
		private static void PriestNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// Text: 1/1.
			// --------------------------------------------------------
			cards.Add("UNG_022e", new CardDef(new Power
			{
			...
			// Text: +1/+1.
			// --------------------------------------------------------
			cards.Add("UNG_037e", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_940t8", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void Rogue(IDictionary<string, CardDef> cards)
		{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_058", new CardDef(new Power
			{
			...
			// - COMBO = 1
			// --------------------------------------------------------
			cards.Add("UNG_063", new CardDef(new Power
			{
				InfoCardId = "UNG_063e",
			...
			// --------------------------------------------------------
			cards.Add("UNG_064", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_FOR_COMBO,0}}, new Power
			{
			...
			// - DEATHRATTLE = 10
			// --------------------------------------------------------
			cards.Add("UNG_065", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_057", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_060", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
					new DrawTask(true),
			...
			// - 676 = 1
			// --------------------------------------------------------
			cards.Add("UNG_067", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_PLAY_MINION)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// - POISONOUS = 1
			// --------------------------------------------------------
			cards.Add("UNG_823", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_WEAPON_EQUIPPED,0}}, new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_856", new CardDef(new Power
			{
			...
			// - DURABILITY = 3a
			// --------------------------------------------------------
			cards.Add("UNG_061", new CardDef(new Power
			{
		...
		private static void RogueNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_063e", new CardDef(new Power
			{
			...
			// - UNTOUCHABLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_065t", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("UNG_057t1", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
			...
			// - RITUAL = 1
			// --------------------------------------------------------
			cards.Add("UNG_067t1", new CardDef(new Power
			{
		...
		private static void Shaman(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_201", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_202", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new IncludeTask(EntityType.HAND),
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("UNG_208", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_TARGET_WITH_DEATHRATTLE,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
					new ConditionTask(EntityType.SOURCE, SelfCondition.ElementalPlayedLastTurn),
					new FlagTask(true, ComplexTask.Create(
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_211", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new ConditionTask(EntityType.SOURCE, SelfCondition.ElementalPlayedLastTurn),
			...
			// - REQ_TARGET_IF_AVAILABLE = 0
			// --------------------------------------------------------
			cards.Add("UNG_938", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0}}, new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_025", new CardDef(new Power
			{
				// TODO: Velen
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("UNG_817", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_TO_PLAY,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - 676 = 1
			// --------------------------------------------------------
			cards.Add("UNG_942", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_SUMMON)
				{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_956", new CardDef(new Power
			{
		...
		private static void ShamanNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_956e", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_942t", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_211a", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_211b", new CardDef(new Power
			{
			...
			// - ImmuneToSpellpower = 1
			// --------------------------------------------------------
			cards.Add("UNG_211c", new CardDef(new Power
			{
			...
			// - ImmuneToSpellpower = 1
			// --------------------------------------------------------
			cards.Add("UNG_211d", new CardDef(new Power
			{
		...
		private static void Warlock(IDictionary<string, CardDef> cards)
		{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_047", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_TARGET_IF_AVAILABLE,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("UNG_049", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_830", new CardDef(new Power
			{
				DeathrattleTask = ComplexTask.Create(
					new IncludeTask(EntityType.SOURCE),
			...
			// - 890 = 2
			// --------------------------------------------------------
			cards.Add("UNG_833", new CardDef(new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_835", new CardDef(new Power
			{
				PowerTask = new DiscoverTask(DiscoverType.SPELL,
					ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("UNG_836", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_829", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.DISCARD)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// --------------------------------------------------------
			cards.Add("UNG_831", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_834", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void WarlockNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_831e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_836e", new CardDef(new Power
			{
			...
			// - UNTOUCHABLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_829t2", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.TURN_END)
				{
					SingleTask = ComplexTask.Create(
			...
			// - REQ_NUM_MINION_SLOTS = 1
			// --------------------------------------------------------
			cards.Add("UNG_829t1", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_NUM_MINION_SLOTS,1}}, new Power
			{
		...
		private static void Warrior(IDictionary<string, CardDef> cards)
		{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("UNG_838", new CardDef(new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_925", new CardDef(new Power
			{
				PowerTask = new AdaptTask(EntityType.SOURCE)
			}));
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_926", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_933", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_957", new CardDef(new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_922", new CardDef(new Power
			{
			...
			// Text: Gain 5 Armor.
			// --------------------------------------------------------
			cards.Add("UNG_923", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_927", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("UNG_934", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_PLAY_MINION)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// - DURABILITY = 1
			// --------------------------------------------------------
			cards.Add("UNG_929", new CardDef(new Power
			{
		...
		private static void WarriorNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("UNG_929e", new CardDef(new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_922t1", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_934t1", new CardDef(new Power
			{
		...
		private static void Neutral(IDictionary<string, CardDef> cards)
		{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_001", new CardDef(new Power
			{
				PowerTask = new AdaptTask(EntityType.SOURCE)
			}));
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_002", new CardDef(new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_009", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_010", new CardDef(new Power
			{
			...
			// - DIVINE_SHIELD = 1
			// --------------------------------------------------------
			cards.Add("UNG_070", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new ConditionTask(EntityType.SOURCE, SelfCondition.ElementalPlayedLastTurn),
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_072", new CardDef(new Power
			{
			...
			// - REQ_FRIENDLY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_073", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_WITH_RACE,14},{PlayReq.REQ_FRIENDLY_TARGET,0}}, new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_075", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_ATTACK)
				{
					TriggerSource = TriggerSource.SELF,
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_076", new CardDef(new Power
			{
			...
			// - FREEZE = 1
			// --------------------------------------------------------
			cards.Add("UNG_079", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_ATTACK)
				{
					TriggerSource = TriggerSource.SELF,
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_082", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new ConditionTask(EntityType.SOURCE, SelfCondition.ElementalPlayedLastTurn),
					new FlagTask(true, new AdaptTask(EntityType.SOURCE)))
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_083", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_084", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_NONSELF_TARGET,0}}, new Power
			{
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("UNG_085", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_087", new CardDef(new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_088", new CardDef(new Power
			{
			...
			// - ADAPT = 1
			// --------------------------------------------------------
			cards.Add("UNG_089", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_099", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_113", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new DrawTask(true),
			...
			// - FREEZE = 1
			// --------------------------------------------------------
			cards.Add("UNG_205", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_ENEMY_TARGET,0}}, new Power
			{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("UNG_801", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new ConditionTask(EntityType.SOURCE, SelfCondition.IsBoardCount(3, RelaSign.GEQ)),
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_803", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_807", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_IF_AVAILABLE,0},{PlayReq.REQ_TARGET_WITH_RACE,23}}, new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_809", new CardDef(new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_816", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_TARGET_WITH_DEATHRATTLE,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
					new ConditionTask(EntityType.SOURCE, SelfCondition.ElementalPlayedLastTurn),
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_818", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_840", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new IncludeTask(EntityType.DECK),
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("UNG_843", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_CAST)
				{
					TriggerSource = TriggerSource.FRIENDLY_SPELL_CASTED_ON_THE_OWNER,
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_845", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_847", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_NONSELF_TARGET,0},{PlayReq.REQ_TARGET_IF_AVAILABE_AND_ELEMENTAL_PLAYED_LAST_TURN,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
					new ConditionTask(EntityType.SOURCE, SelfCondition.ElementalPlayedLastTurn),
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_848", new CardDef(new Power
			{
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_851", new CardDef(new Power
			{
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("UNG_900", new CardDef(new Power
			{
				Trigger = new Trigger(TriggerType.AFTER_SUMMON)
				{
					TriggerSource = TriggerSource.FRIENDLY,
			...
			// - BATTLECRY = 1
			// --------------------------------------------------------
			cards.Add("UNG_907", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("UNG_928", new CardDef(new Power
			{
			...
			// - DISCOVER = 1
			// --------------------------------------------------------
			cards.Add("UNG_937", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_TARGET_WITH_DEATHRATTLE = 0
			// --------------------------------------------------------
			cards.Add("UNG_946", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_FRIENDLY_TARGET,0},{PlayReq.REQ_MINION_TARGET,0},{PlayReq.REQ_TARGET_WITH_DEATHRATTLE,0}}, new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void NeutralNonCollect(IDictionary<string, CardDef> cards)
		{
			...
			// - 758 = 1
			// --------------------------------------------------------
			cards.Add("UNG_067t1e", new CardDef(new Power
			{
			...
			// - 758 = 1
			// --------------------------------------------------------
			cards.Add("UNG_067t1e2", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_070e", new CardDef(new Power
			{
			...
			// Text: +1/+1
			// --------------------------------------------------------
			cards.Add("UNG_073e", new CardDef(new Power
			{
			...
			// Text: Costs (5).
			// --------------------------------------------------------
			cards.Add("UNG_113e", new CardDef(new Power
			{
			...
			// Text: Costs (1) less.
			// --------------------------------------------------------
			cards.Add("UNG_202e", new CardDef(new Power
			{
			...
			// Text: Increased stats.
			// --------------------------------------------------------
			cards.Add("UNG_807e", new CardDef(new Power
			{
			...
			// - POISONOUS = 1
			// --------------------------------------------------------
			cards.Add("UNG_823e", new CardDef(new Power
			{
			...
			// Text: <b>Poisonous</b>
			// --------------------------------------------------------
			cards.Add("UNG_823ed", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_832e", new CardDef(new Power
			{
			...
			// Text: +5 Health
			// --------------------------------------------------------
			cards.Add("UNG_907e", new CardDef(new Power
			{
			...
			// Text: <b>Poisonous</b>
			// --------------------------------------------------------
			cards.Add("UNG_999t13e", new CardDef(new Power
			{
			...
			// Text: +1/+1.
			// --------------------------------------------------------
			cards.Add("UNG_999t14e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_999t2e", new CardDef(new Power
			{
			...
			// Text: +3 Attack.
			// --------------------------------------------------------
			cards.Add("UNG_999t3e", new CardDef(new Power
			{
			...
			// Text: +3 Health.
			// --------------------------------------------------------
			cards.Add("UNG_999t4e", new CardDef(new Power
			{
			...
			// - CANT_BE_TARGETED_BY_HERO_POWERS = 1
			// --------------------------------------------------------
			cards.Add("UNG_999t5e", new CardDef(new Power
			{
			...
			// Text: <b>Taunt</b>
			// --------------------------------------------------------
			cards.Add("UNG_999t6e", new CardDef(new Power
			{
			...
			// Text: <b>Windfury</b>
			// --------------------------------------------------------
			cards.Add("UNG_999t7e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_999t8e", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("UNG_851t1", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t10", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t13", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t14", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t2", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t3", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t4", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t5", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t6", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t7", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("UNG_999t8", new CardDef(new Dictionary<PlayReq, int>() {{PlayReq.REQ_TARGET_TO_PLAY,0},{PlayReq.REQ_MINION_TARGET,0}}, new Power
			{
