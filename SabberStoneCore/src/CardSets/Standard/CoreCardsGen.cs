...
namespace SabberStoneCore.CardSets.Standard
{
	...
	public class CoreCardsGen
	{
		...
		private static void HeroPowers(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("CS1h_001", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_034", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("CS2_049", new CardDef(new Power
			{
			...
			// - REQ_NUM_MINION_SLOTS = 1
			// --------------------------------------------------------
			cards.Add("CS2_101", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("DS1h_292", new CardDef(new Power
			{
		...
		private static void Druid(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_007", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_008", new CardDef(new Power
			{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("CS2_009", new CardDef(new Power
			{
			...
			// - REQ_ENEMY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_012", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("EX1_173", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void Hunter(IDictionary<string, CardDef> cards)
		{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("DS1_070", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_084", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("DS1_183", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("DS1_185", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("EX1_539", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_NUM_MINION_SLOTS = 1
			// --------------------------------------------------------
			cards.Add("NEW1_031", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void Mage(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_022", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_024", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("CS2_027", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_029", new CardDef(new Power
			{
		...
		private static void Paladin(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_087", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_089", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_092", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_094", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new DamageTask(3, EntityType.TARGET, true),
					new DrawTask())
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("EX1_360", new CardDef(new Power
			{
			...
			// - DIVINE_SHIELD = 1
			// --------------------------------------------------------
			cards.Add("EX1_371", new CardDef(new Power
			{
		...
		private static void Priest(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_NUM_MINION_SLOTS = 1
			// --------------------------------------------------------
			cards.Add("CS1_113", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS1_130", new CardDef(new Power
			{
				PowerTask = new DamageTask(2, EntityType.TARGET, true)
			}));
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_004", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_234", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_236", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// --------------------------------------------------------
			cards.Add("EX1_622", new CardDef(new Power
			{
				PowerTask = new DestroyTask(EntityType.TARGET)
			}));
		...
		private static void Rogue(IDictionary<string, CardDef> cards)
		{
			...
			// - POISONOUS = 1
			// --------------------------------------------------------
			cards.Add("EX1_191", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("CS2_072", new CardDef(new Power
			{
				PowerTask = new DamageTask(2, EntityType.TARGET, true)
			}));
			...
			// --------------------------------------------------------
			cards.Add("CS2_074", new CardDef(new Power
			{
			...
			// - REQ_ENEMY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_076", new CardDef(new Power
			{
				PowerTask = new DestroyTask(EntityType.TARGET)
			}));
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("EX1_278", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_ENEMY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("EX1_581", new CardDef(new Power
			{
		...
		private static void Shaman(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_TARGET_IF_AVAILABLE = 0
			// --------------------------------------------------------
			cards.Add("CS2_042", new CardDef(new Power
			{
			...
			// - WINDFURY = 1
			// --------------------------------------------------------
			cards.Add("EX1_587", new CardDef(new Power
			{
			...
			// - REQ_ENEMY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_037", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new DamageTask(1, EntityType.TARGET, true),
					ComplexTask.Freeze(EntityType.TARGET))
			...
			// - WINDFURY = 1
			// --------------------------------------------------------
			cards.Add("CS2_039", new CardDef(new Power
			{
				PowerTask = ComplexTask.WindFury(EntityType.TARGET)
			}));
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("CS2_041", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_FRIENDLY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_045", new CardDef(new Power
			{
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("EX1_246", new CardDef(new Power
			{
		...
		private static void Warlock(IDictionary<string, CardDef> cards)
		{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_057", new CardDef(new Power
			{
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("CS2_061", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
			...
			// - REQ_ENEMY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_063", new CardDef(new Power
			{
			...
			// - REQ_MINION_TARGET = 0
			// --------------------------------------------------------
			cards.Add("EX1_302", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new DamageTask(1, EntityType.TARGET, true),
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("EX1_308", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
					new DamageTask(4, EntityType.TARGET, true),
			...
			// --------------------------------------------------------
			cards.Add("NEW1_003", new CardDef(new Power
			{
				PowerTask = ComplexTask.Create(
		...
		private static void Warrior(IDictionary<string, CardDef> cards)
		{
			...
			// - CHARGE = 1
			// --------------------------------------------------------
			cards.Add("CS2_103", new CardDef(new Power
			{
			...
			// --------------------------------------------------------
			cards.Add("CS2_108", new CardDef(new Power
			{
				PowerTask = new DestroyTask(EntityType.TARGET)
			}));
			...
			// --------------------------------------------------------
			cards.Add("CS2_114", new CardDef(new Power
			{
		...
		private static void Neutral(IDictionary<string, CardDef> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("CS2_141", new CardDef(new Power
			{
				PowerTask = new DamageTask(1, EntityType.TARGET)
			}));
			...
			// - REQ_NONSELF_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_150", new CardDef(new Power
			{
			...
			// - REQ_NONSELF_TARGET = 0
			// --------------------------------------------------------
			cards.Add("CS2_189", new CardDef(new Power
			{
				PowerTask = new DamageTask(1, EntityType.TARGET)
			}));
			...
			// - REQ_TARGET_IF_AVAILABLE = 0
			// --------------------------------------------------------
			cards.Add("EX1_011", new CardDef(new Power
			{
				PowerTask = new HealTask(2, EntityType.TARGET)
			}));
			...
			// - REQ_FRIENDLY_TARGET = 0
			// --------------------------------------------------------
			cards.Add("EX1_019", new CardDef(new Power
			{
