...
namespace SabberStoneCore.CardSets.Standard
{
	public class IcecrownCardsGen
	{
		private static void Heroes(IDictionary<string, Power> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("ICCA01_013", new Power {
			...
			// - Set: icecrown, 
			// --------------------------------------------------------
			cards.Add("ICCA03_001", new Power {
			...
			// - HERO_POWER = 45627
			// --------------------------------------------------------
			cards.Add("ICCA04_001", new Power {
			...
			// - HERO_POWER = 43194
			// --------------------------------------------------------
			cards.Add("ICCA05_001", new Power {
			...
			// - HERO_POWER = 42447
			// --------------------------------------------------------
			cards.Add("ICCA06_001", new Power {
			...
			// - HERO_POWER = 42876
			// --------------------------------------------------------
			cards.Add("ICCA07_001", new Power {
			...
			// - HERO_POWER = 42876
			// --------------------------------------------------------
			cards.Add("ICCA07_001h2", new Power {
			...
			// - HERO_POWER = 42876
			// --------------------------------------------------------
			cards.Add("ICCA07_001h3", new Power {
			...
			// - HERO_POWER = 42457
			// --------------------------------------------------------
			cards.Add("ICCA08_001", new Power {
			...
			// - HERO_POWER = 43038
			// --------------------------------------------------------
			cards.Add("ICCA09_002", new Power {
			...
			// - HERO_POWER = 45605
			// --------------------------------------------------------
			cards.Add("ICCA10_009", new Power {
		...
		private static void HeroPowers(IDictionary<string, Power> cards)
		{
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA04_008p", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA04_009p", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA04_010p", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA04_011p", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA05_002p", new Power {
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("ICCA05_004p", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA06_002p", new Power {
			...
			// - HIDE_STATS = 1
			// --------------------------------------------------------
			cards.Add("ICCA07_002p", new Power {
			...
			// - HIDE_STATS = 1
			// --------------------------------------------------------
			cards.Add("ICCA07_003p", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA07_005p", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA08_002p", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_030p", new Power {
			...
			// - HIDE_STATS = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_032p", new Power {
			...
			// - HIDE_STATS = 1
			// --------------------------------------------------------
			cards.Add("ICCA09_001p", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA10_009p", new Power {
		...
		private static void DeathknightNonCollect(IDictionary<string, Power> cards)
		{
			...
			// Text: 1/1.
			// --------------------------------------------------------
			cards.Add("ICCA08_023e", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA01_003", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA01_004", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_021", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_022", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_023", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_024", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_025", new Power {
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("ICCA08_026", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_027", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_028", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_029", new Power {
			...
			// - DURABILITY = 3
			// --------------------------------------------------------
			cards.Add("ICCA01_005", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA08_020", new Power {
		...
		private static void MageNonCollect(IDictionary<string, Power> cards)
		{
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA04_002", new Power {
		...
		private static void WarlockNonCollect(IDictionary<string, Power> cards)
		{
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("ICCA05_020", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA05_021", new Power {
		...
		private static void NeutralNonCollect(IDictionary<string, Power> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("ICCA05_002e", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA07_004e", new Power {
			...
			// - Set: icecrown, 
			// --------------------------------------------------------
			cards.Add("ICCA08_022e", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA08_022e2", new Power {
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("ICCA01_004t", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA01_007", new Power {
			...
			// - Set: icecrown, 
			// --------------------------------------------------------
			cards.Add("ICCA01_008", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA01_009", new Power {
			...
			// - CANT_ATTACK = 1
			// --------------------------------------------------------
			cards.Add("ICCA01_010", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA01_011", new Power {
			...
			// - UNTOUCHABLE = 1
			// --------------------------------------------------------
			cards.Add("ICCA04_004", new Power {
			...
			// - Set: icecrown, 
			// --------------------------------------------------------
			cards.Add("ICCA05_003", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA06_005", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA07_004", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("ICCA07_008", new Power {
			...
			// - Set: icecrown, 
			// --------------------------------------------------------
			cards.Add("ICCA08_002t", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA08_017", new Power {
			...
			// - Set: icecrown, 
			// --------------------------------------------------------
			cards.Add("ICCA08_033", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA09_001t1", new Power {
			...
			// - CANT_ATTACK = 1
			// --------------------------------------------------------
			cards.Add("ICCA10_001", new Power {
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("ICCA11_001", new Power {
			...
			// --------------------------------------------------------
			cards.Add("ICCA06_004", new Power {
			...
			// - WINDFURY = 1
			// --------------------------------------------------------
			cards.Add("ICCA06_003", new Power {
			...
			// - DURABILITY = 6
			// --------------------------------------------------------
			cards.Add("ICCA07_020", new Power {
