...
namespace SabberStoneCore.Tasks.SimpleTasks
{
	...
	{
		private IReadOnlySet<Card> _kazakusPotionSpells;

		private IReadOnlySet<Card> KazakusPotionSpells => _kazakusPotionSpells ?? (_kazakusPotionSpells = GetKazakusPotionSpells());
		...
		private static IReadOnlySet<Card> GetKazakusPotionSpells()
		{
			...
			return LightWeightOrderedSet<Card>.Build(enumerable);
		}
