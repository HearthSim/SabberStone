...
namespace SabberStoneCore.Tasks.SimpleTasks
{
    ...
    public class DiscoverTask : SimpleTask
    {
        ...
        public override TaskState Process()
        {
            ...
            var success = Generic.CreateChoiceCards.Invoke(Controller, ChoiceType.GENERAL, choiceAction, resultCards.ToList());
        ...
        private void ProcessSplit(List<Card>[] cardsToDiscover, ChoiceAction choiceAction)
        {
            ...
            combinations.ForEach(p =>
            {
                ...
                var success = Generic.CreateChoiceCards.Invoke(cloneController, ChoiceType.GENERAL, choiceAction, p.ToList());
