    ...
    public partial class Entity : IEntity
    {
        ...
        public int this[GameTag t]
        {
            get
            {
                ...
                Log.Debug($"{this} get org. data {t} = {_data[t]}");
                var value = _data[t];
            ...
            set
            {
                ...
                Log.Debug($"{this} set data {t} to {value} oldvalue {oldValue}");
                if (oldValue == value)
                {
                    Log.Debug($"{this} set data {t} to {value} obsolet as value is already that value.");
                    return;
                }
                _data[t] = value;
