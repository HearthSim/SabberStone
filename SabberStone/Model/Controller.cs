...
namespace SabberStone.Model
{
    public partial class Controller : Entity
    {
            ...
            }, playerId)
        {
            ...
            Log.Debug($"Created Controller '{name}'");
        }
        ...
        public Deck Deck => Zones[HearthDb.Enums.Zone.DECK] as Deck;

        public Hand Hand => Zones[HearthDb.Enums.Zone.HAND] as Hand;

        public Zone<Minion> Board => Zones[HearthDb.Enums.Zone.PLAY] as Zone<Minion>;

        public Zone<IPlayable> Graveyard => Zones[HearthDb.Enums.Zone.GRAVEYARD] as Zone<IPlayable>;
