...
namespace SabberStone.Loader
{
    ...
    internal class CardLoader : ICardLoader
    {
        ...
        {
            var playErr = XDocument.Load(@Path + @"SabberStone\HSProtoSim\Loader\Data\PlayErrors.xml");
        ...
        public List<Card> Load()
        {
            ...
            var cardDefsXml = XDocument.Load(@Path + @"SabberStone\HSProtoSim\Loader\Data\CardDefs.xml");
            var cardXml = XDocument.Load(@Path + @"SabberStone\HSProtoSim\Loader\Data\CARD.xml");
            // Parse XML
