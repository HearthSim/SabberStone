...
namespace SabberStoneCoreTest.CardSets.Standard
{
    ...
    public class MageExpert1Test
    {
        ...
        public void IceBarrier_EX1_289()
        {
            ...
            game.Process(MinionAttackTask.Any(game.CurrentPlayer, minion, game.CurrentOpponent.Hero));
            Assert.AreEqual(0, game.CurrentOpponent.Secrets.Count);
            Assert.AreEqual(7, game.CurrentOpponent.Hero.Armor);
        }
    ...
    public class RogueExpert1Test
    {
        ...
        public void Headcrack_EX1_137()
        {
            ...
            Assert.AreEqual(testCard1.Card.Id, game.CurrentOpponent.Hand[5].Card.Id);
        }
    ...
    public class ShamanExpert1Test
    {
        ...
        public void AncestralSpirit_CS2_038()
        {
            ...
            game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell, minion));
            Assert.AreEqual(1, game.CurrentOpponent.Board.Count);
            Assert.AreNotEqual(minion, game.CurrentOpponent.Board[0]);
            Assert.AreEqual(minion.Card.Id, game.CurrentOpponent.Board[0].Card.Id);
        }
    ...
    public class WarlockExpert1Test
    {
        ...
        public void Shadowflame_EX1_303()
        {
            ...
            Assert.AreEqual(true, minion2.ToBeDestroyed);
            Assert.AreEqual(1, ((Minion) minion3).Health);
        }
        ...
        public void SenseDemons_EX1_317()
        {
            ...
            game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard));
            Assert.AreEqual(6, game.CurrentPlayer.Hand.Count);
            Assert.AreEqual(Race.DEMON, game.CurrentPlayer.Hand[5].Card.Race);
            Assert.AreEqual(Race.DEMON, game.CurrentPlayer.Hand[4].Card.Race);
        }
        ...
        public void Felguard_EX1_301()
        {
            ...
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
            Assert.AreEqual(4, game.CurrentPlayer.BaseMana);
        }
        ...
        public void VoidTerror_EX1_304()
        {
            ...
            Assert.AreEqual(1, minionA.AttackDamage);
            Assert.AreEqual(1, minionA.Health);
            Assert.AreEqual(3, minionB.AttackDamage);
            Assert.AreEqual(2, minionB.Health);
            ...
            Assert.AreEqual(true, minionA.IsDead);
            Assert.AreEqual(true, minionB.IsDead);
            Assert.AreEqual(7, minion.AttackDamage);
            Assert.AreEqual(6, minion.Health);
        }
    ...
    public class WarriorExpert1Test
    {
        ...
        public void Brawl_EX1_407()
        {
            ...
            game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard));
            Assert.AreEqual(1, game.CurrentPlayer.Board.Count + game.CurrentOpponent.Board.Count);
        }
        ...
        public void Gorehowl_EX1_411()
        {
            ...
            game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard1));
            game.Process(HeroAttackTask.Any(game.CurrentPlayer, game.CurrentOpponent.Hero));
            Assert.AreEqual(23, game.CurrentOpponent.Hero.Health);
            Assert.AreEqual(true, game.CurrentOpponent.Hero.Weapon == null);
            ...
            Assert.AreEqual(6, game.CurrentPlayer.Hero.Weapon.AttackDamage);
        }
    }
    ...
    public class NeutralExpert1Test
    {
        ...
        public void SunfuryProtector_EX1_058()
        {
            ...
            Assert.AreEqual(true, ((Minion) minion1).HasTaunt);
            Assert.AreEqual(true, ((Minion) minion2).HasTaunt);
        }
        ...
        public void PintSizedSummoner_EX1_076()
        {
            ...
            var minion2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Bloodfen Raptor"));
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
            Assert.AreEqual(2, minion1.Cost);
            game.Process(EndTurnTask.Any(game.CurrentPlayer));
            game.Process(EndTurnTask.Any(game.CurrentPlayer));
            Assert.AreEqual(1, minion1.Cost);
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion1));
            Assert.AreEqual(2, minion2.Cost);
        }
        ...
        public void LorewalkerCho_EX1_100()
        {
            ...
            game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell1, game.CurrentOpponent.Hero));
            Assert.AreEqual(6, game.CurrentOpponent.Hand.Count);
            Assert.AreEqual(spell1.Card.Id, game.CurrentOpponent.Hand[5].Card.Id);
            game.Process(EndTurnTask.Any(game.CurrentPlayer));
            var spell2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Fireball"));
            Assert.AreEqual(4, game.CurrentOpponent.Hand.Count);
            game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell2, game.CurrentOpponent.Hero));
            Assert.AreEqual(5, game.CurrentOpponent.Hand.Count);
            Assert.AreEqual(spell2.Card.Id, game.CurrentOpponent.Hand[4].Card.Id);
        }
        ...
        public void MountainGiant_EX1_105()
        {
            ...
            Assert.AreEqual(5, game.CurrentPlayer.Hand.Count);
            Assert.AreEqual(8, testCard.Cost);
        }
        ...
        public void HarrisonJones_EX1_558()
        {
            ...
            Assert.AreEqual(7, game.CurrentPlayer.Hand.Count);
            game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard));
            Assert.AreEqual(8, game.CurrentPlayer.Hand.Count);
        }
        ...
        public void Nozdormu_EX1_560()
        {
            ...
            Assert.AreEqual(75, game.Player1.TimeOut);
            Assert.AreEqual(75, game.Player2.TimeOut);
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
            Assert.AreEqual(20, game.Player1.TimeOut);
            Assert.AreEqual(20, game.Player2.TimeOut);
        }
        ...
        public void AncientMage_EX1_584()
        {
            ...
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion2));
            game.Process(PlayCardTask.Any(game.CurrentPlayer, testCard, null, 1));
            Assert.AreEqual(2, game.CurrentPlayer.Hero.SpellPowerDamage);
        }
        ...
        public void BloodKnight_EX1_590()
        {
            ...
            Assert.AreEqual(false, ((Minion) minion2).HasDivineShield);
            Assert.AreEqual(9, ((Minion) testCard).AttackDamage);
            Assert.AreEqual(9, ((Minion) testCard).Health);
        }
        ...
        public void ManaWraith_EX1_616()
        {
            ...
            Assert.AreEqual(4, game.CurrentPlayer.Hand[1].Cost);
        }
        ...
        public void FaerieDragon_NEW1_023()
        {
            ...
            var spell = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Frostbolt"));
            game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell, testCard));
            Assert.AreEqual(false, ((Minion) testCard).IsDead);
            Assert.AreEqual(2, ((Minion) testCard).Health);
        }
