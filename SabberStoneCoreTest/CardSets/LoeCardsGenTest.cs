...
namespace SabberStoneCoreTest.CardSets
{
	...
	public class DruidLoeTest
	{
		...
		public void RavenIdol_LOE_115()
		{
            ...
            Assert.AreEqual(CardType.MINION, game.IdEntityDic[game.CurrentPlayer.Choice.Choices[0]].Card.Type);
            game.Process(ChooseTask.Pick(game.CurrentPlayer, game.CurrentPlayer.Choice.Choices[0]));
            Assert.AreEqual(6, game.CurrentPlayer.Hand.Count);
            game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard2, 2));
            Assert.AreEqual(CardType.SPELL, game.IdEntityDic[game.CurrentPlayer.Choice.Choices[0]].Card.Type);
            game.Process(ChooseTask.Pick(game.CurrentPlayer, game.CurrentPlayer.Choice.Choices[0]));
            Assert.AreEqual(6, game.CurrentPlayer.Hand.Count);
        }
    ...
    public class NeutralLoeTest
	{
		...
		public void NagaSeaWitch_LOE_038()
		{
            ...
            game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
            Assert.AreEqual(5, game.CurrentPlayer.Hand[0].Cost);
            Assert.AreEqual(5, game.CurrentPlayer.Hand[1].Cost);
            Assert.AreEqual(5, game.CurrentPlayer.Hand[2].Cost);
        }
		...
		public void SirFinleyMrrgglton_LOE_076()
		{
            ...
            Assert.AreEqual(choice, game.CurrentPlayer.Hero.Power.Id);
