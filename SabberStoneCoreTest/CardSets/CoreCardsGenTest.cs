...
namespace SabberStoneCoreTest.CardSets
{
    ...
    public class HunterCoreTest
    {
        ...
        public void StarvingBuzzard_CS2_237()
        {
            ...
            Assert.AreEqual(5, game.CurrentPlayer[GameTag.NUM_CARDS_DRAWN_THIS_TURN]);
        }
    ...
    public class MageCoreTest
    {
        ...
        public void Polymorph_CS2_022()
        {
            ...
            Assert.AreEqual(zonePosition, game.CurrentOpponent.Board[0][GameTag.ZONE_POSITION]);
            Assert.AreEqual(zone, game.CurrentOpponent.Board[0][GameTag.ZONE]);
            Assert.AreNotEqual(game.CurrentOpponent.Board[0][GameTag.ZONE], m1);
        ...
        public void ArcaneIntellect_CS2_023()
        {
            ...
            Assert.AreEqual(4, game.Player1[GameTag.NUM_CARDS_DRAWN_THIS_TURN]);
