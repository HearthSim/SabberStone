...
namespace SabberStoneCore.CardSets.Undefined
{
	public class LoeCardsGenAdv
	{
		private static void Heroes(IDictionary<string, Power> cards)
		{
			...
			// - HERO_POWER = 38479
			// --------------------------------------------------------
			cards.Add("LOEA01_01h", new Power {
			...
			// - HERO_POWER = 38465
			// --------------------------------------------------------
			cards.Add("LOEA02_01h", new Power {
			...
			// - HERO_POWER = 38510
			// --------------------------------------------------------
			cards.Add("LOEA04_01h", new Power {
			...
			// - HERO_POWER = 38555
			// --------------------------------------------------------
			cards.Add("LOEA05_01h", new Power {
			...
			// - HERO_POWER = 38676
			// --------------------------------------------------------
			cards.Add("LOEA07_02h", new Power {
			...
			// - HERO_POWER = 38588
			// --------------------------------------------------------
			cards.Add("LOEA08_01h", new Power {
		...
		private static void HeroPowers(IDictionary<string, Power> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("LOEA01_02h", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("LOEA02_02h", new Power {
			...
			// Text: Encounter new obstacles!
			// --------------------------------------------------------
			cards.Add("LOEA04_02h", new Power {
			...
			//        Enemy minions cost (2) more. Swap at the start of your turn.
			// --------------------------------------------------------
			cards.Add("LOEA05_02a", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA05_02h", new Power {
			...
			//        Enemy minions cost (11). Swap at the start of your turn.
			// --------------------------------------------------------
			cards.Add("LOEA05_02ha", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA05_03h", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("LOEA06_02h", new Power {
			...
			// - AI_MUST_PLAY = 1
			// --------------------------------------------------------
			cards.Add("LOEA07_03h", new Power {
			...
			// Entourage: LOEA16_10, LOEA16_11, LOEA16_14, LOEA16_15, LOEA16_6, LOEA16_7, LOEA16_9, LOEA16_12, LOEA16_13, LOEA16_8
			// --------------------------------------------------------
			cards.Add("LOEA16_16H", new Power {
		...
		private static void HunterNonCollect(IDictionary<string, Power> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("LOEA02_10a", new Power {
			...
			// - REQ_NUM_MINION_SLOTS = 1
			// --------------------------------------------------------
			cards.Add("LOEA02_10c", new Power {
		...
		private static void NeutralNonCollect(IDictionary<string, Power> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("LOEA01_11he", new Power {
			...
			// - Set: loe, 
			// --------------------------------------------------------
			cards.Add("LOEA04_01e", new Power {
			...
			// - Set: loe, 
			// --------------------------------------------------------
			cards.Add("LOEA04_01eh", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA06_03e", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA06_03eh", new Power {
			...
			// - TAG_ONE_TURN_EFFECT = 1
			// --------------------------------------------------------
			cards.Add("LOEA09_2eH", new Power {
			...
			// Text: Quite Hungry.
			// --------------------------------------------------------
			cards.Add("LOEA09_3aH", new Power {
			...
			// - TAG_ONE_TURN_EFFECT = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_20e", new Power {
			...
			// Text: <b>Immune</b>.
			// --------------------------------------------------------
			cards.Add("LOEA16_20H", new Power {
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("LOEA01_11h", new Power {
			...
			// - DEATHRATTLE = 1
			// --------------------------------------------------------
			cards.Add("LOEA01_12h", new Power {
			...
			// - DIVINE_SHIELD = 1
			// --------------------------------------------------------
			cards.Add("LOEA04_13bt", new Power {
			...
			// - DIVINE_SHIELD = 1
			// --------------------------------------------------------
			cards.Add("LOEA04_13bth", new Power {
			...
			// - Set: loe, 
			// --------------------------------------------------------
			cards.Add("LOEA04_23h", new Power {
			...
			// - Set: loe, 
			// --------------------------------------------------------
			cards.Add("LOEA04_24h", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA04_25h", new Power {
			...
			// - Set: loe, 
			// --------------------------------------------------------
			cards.Add("LOEA06_02t", new Power {
			...
			// - Set: loe, 
			// --------------------------------------------------------
			cards.Add("LOEA06_02th", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_18H", new Power {
			...
			// - IMMUNE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_19H", new Power {
			...
			// - AURA = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_21H", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_22H", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_23H", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_24H", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_25H", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_26H", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("LOEA16_27H", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA04_06a", new Power {
			...
			// Text: Take 5 damage.
			// --------------------------------------------------------
			cards.Add("LOEA04_06b", new Power {
			...
			// Text: Draw a card.
			// --------------------------------------------------------
			cards.Add("LOEA04_28a", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA04_28b", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA04_29a", new Power {
			...
			// Text: Draw 2 cards.
			// --------------------------------------------------------
			cards.Add("LOEA04_29b", new Power {
			...
			// --------------------------------------------------------
			cards.Add("LOEA04_30a", new Power {
			...
			// Text: Do nothing.
			// --------------------------------------------------------
			cards.Add("LOEA04_31b", new Power {
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("LOEA06_03h", new Power {
			...
			// - REQ_TARGET_TO_PLAY = 0
			// --------------------------------------------------------
			cards.Add("LOEA06_04h", new Power {
