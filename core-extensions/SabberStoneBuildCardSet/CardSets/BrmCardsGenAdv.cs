...
namespace SabberStoneCore.CardSets.Undefined
{
	public class BrmCardsGenAdv
	{
		...
		private static void HeroPowers(IDictionary<string, Power> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("BRMA14_10H", new Power {
		...
		private static void NeutralNonCollect(IDictionary<string, Power> cards)
		{
			...
			// --------------------------------------------------------
			cards.Add("BRMA05_3He", new Power {
			...
			// Text: +2/+2
			// --------------------------------------------------------
			cards.Add("BRMA12_8te", new Power {
			...
			// Text: +2/+2.
			// --------------------------------------------------------
			cards.Add("BRMA15_2He", new Power {
			...
			// - Race: dragon, Set: brm, 
			// --------------------------------------------------------
			cards.Add("BRMA09_2Ht", new Power {
			...
			// - TAUNT = 1
			// --------------------------------------------------------
			cards.Add("BRMA09_3Ht", new Power {
			...
			// - Race: dragon, Set: brm, 
			// --------------------------------------------------------
			cards.Add("BRMA09_4Ht", new Power {
			...
			// - ELITE = 1
			// --------------------------------------------------------
			cards.Add("BRMA09_5Ht", new Power {
