...
namespace SabberStoneCoreTest.CardSets.Undefined
{
	public class HeroesTbTest
	{
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void CatacombBoss_TB_BuildaBoss_001()
		{
			// TODO CatacombBoss_TB_BuildaBoss_001 test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Catacomb Boss"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Catacomb Boss"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void HeadlessHorseman_TB_HeadlessHorseman_H1()
		{
			// TODO HeadlessHorseman_TB_HeadlessHorseman_H1 test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
				Player1Deck = new List<Card>()
				{
					Cards.FromName("Headless Horseman"),
				},
				Player2HeroClass = CardClass.MAGE,
				Shuffle = false,
				FillDecks = true,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Headless Horseman"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Headless Horseman"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void HeadlessHorsemanNoHead_TB_HeadlessHorseman_H1a()
		{
			// TODO HeadlessHorsemanNoHead_TB_HeadlessHorseman_H1a test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
				Player1Deck = new List<Card>()
				{
					Cards.FromName("Headless Horseman (no head)"),
				},
				Player2HeroClass = CardClass.MAGE,
				Shuffle = false,
				FillDecks = true,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Headless Horseman (no head)"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Headless Horseman (no head)"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void StormwindInvestigator_TB_HeadlessHorseman_H2()
		{
			// TODO StormwindInvestigator_TB_HeadlessHorseman_H2 test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
				Player1Deck = new List<Card>()
				{
					Cards.FromName("Stormwind Investigator"),
				},
				Player2HeroClass = CardClass.MAGE,
				Shuffle = false,
				FillDecks = true,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Stormwind Investigator"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Stormwind Investigator"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void StormwindInvestigatorWitch_TB_HeadlessHorseman_H2a()
		{
			// TODO StormwindInvestigatorWitch_TB_HeadlessHorseman_H2a test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
				Player1Deck = new List<Card>()
				{
					Cards.FromName("Stormwind Investigator Witch"),
				},
				Player2HeroClass = CardClass.MAGE,
				Shuffle = false,
				FillDecks = true,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Stormwind Investigator Witch"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Stormwind Investigator Witch"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void StormwindInvestigatorCat_TB_HeadlessHorseman_H2b()
		{
			// TODO StormwindInvestigatorCat_TB_HeadlessHorseman_H2b test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
				Player1Deck = new List<Card>()
				{
					Cards.FromName("Stormwind Investigator Cat"),
				},
				Player2HeroClass = CardClass.MAGE,
				Shuffle = false,
				FillDecks = true,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Stormwind Investigator Cat"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Stormwind Investigator Cat"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void StormwindInvestigatorPirate_TB_HeadlessHorseman_H2c()
		{
			// TODO StormwindInvestigatorPirate_TB_HeadlessHorseman_H2c test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
				Player1Deck = new List<Card>()
				{
					Cards.FromName("Stormwind Investigator Pirate"),
				},
				Player2HeroClass = CardClass.MAGE,
				Shuffle = false,
				FillDecks = true,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Stormwind Investigator Pirate"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Stormwind Investigator Pirate"));
		}
	...
	public class HeroPowersTbTest
	{
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void ToxicFumes_TB_BuildaBoss_404p()
		{
			// TODO ToxicFumes_TB_BuildaBoss_404p test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Toxic Fumes"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Toxic Fumes"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void Slash_TB_HeadlessHorseman_HP1()
		{
			// TODO Slash_TB_HeadlessHorseman_HP1 test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Slash"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Slash"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void Conscript_TB_HeadlessHorseman_HP3()
		{
			// TODO Conscript_TB_HeadlessHorseman_HP3 test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Conscript"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Conscript"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void Witchcraft_TB_HeadlessHorseman_HP4()
		{
			// TODO Witchcraft_TB_HeadlessHorseman_HP4 test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Witchcraft"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Witchcraft"));
		}
		...
		// --------------------------------------------------------
		[Fact(Skip = "ignore")]
		public void SenseWeakness_TB_HeadlessHorseman_HP5()
		{
			// TODO SenseWeakness_TB_HeadlessHorseman_HP5 test
			var game = new Game(new GameConfig
			{
				StartPlayer = 1,
				Player1HeroClass = CardClass.MAGE,
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//var testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Sense Weakness"));
			//game.Process(PlayCardTask.Any(game.CurrentPlayer, "Sense Weakness"));
		}
